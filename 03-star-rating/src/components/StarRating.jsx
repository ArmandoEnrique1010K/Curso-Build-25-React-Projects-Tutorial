...
// Ejecuta el comando "npm install react-icons --save" para instalar la libreria
...
export default function StarRating({ noOfStars = 5 }) {
  ...
  return (
    <div className="star-rating">
      ...
      {/* El uso del carácter de subrayado (_) en el método map es una convención común en JavaScript para indicar que un argumento no se 
            utiliza dentro de la función de mapeo. El carácter de subrayado se utiliza para mostrar que el primer argumento (que representa el 
            elemento actual en la iteración) no es relevante o no se va a utilizar. */}
